...
3) Access the `workbench` named `codegen-r1731941967487-notebook`.
...
5) In the terminal, run `cd codegen-r1731941967487` to navigate to your sample app's directory.
